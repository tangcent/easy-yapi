...
class GrpcSettingsTest {
    ...
    fun testCustomValues() {
        ...
        assertFalse(settings.grpcEnable)
    ...
    @Test
    fun testEqualsDifferentGrpcEnable() {
        val s1 = GrpcSettings(grpcEnable = true)
        val s2 = GrpcSettings(grpcEnable = false)
    ...
    fun testCopyWithModification() {
        val original = GrpcSettings(grpcEnable = true)
        val modified = original.copy(grpcEnable = false)
        assertNotEquals(original, modified)
        assertFalse(modified.grpcEnable)
    }
}
