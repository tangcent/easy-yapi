...
class NativeFeignAnnotationParserPureTest {
    ...
    fun testHttpMethodFromSpringValidMethods() {
        ...
        for (m in methods) {
            val result = com.itangcent.easyapi.core.export.HttpMethod.fromSpring(m)
    ...
    fun testHttpMethodFromSpringCaseInsensitive() {
        val result = com.itangcent.easyapi.core.export.HttpMethod.fromSpring("get")
    ...
    fun testHttpMethodFromSpringInvalidMethod() {
        val result = com.itangcent.easyapi.core.export.HttpMethod.fromSpring("INVALID")
        assertNull(result)
    }
