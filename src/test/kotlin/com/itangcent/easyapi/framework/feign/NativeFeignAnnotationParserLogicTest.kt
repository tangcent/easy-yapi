...
class NativeFeignAnnotationParserLogicTest {
    ...
    fun `RequestLine data class`() {
        val requestLine = RequestLine(
            method = com.itangcent.easyapi.core.export.HttpMethod.GET,
            path = "/api/users"
        )
        assertEquals(com.itangcent.easyapi.core.export.HttpMethod.GET, requestLine.method)
    ...
    fun `RequestLine copy`() {
        ...
        val copy = requestLine.copy(method = com.itangcent.easyapi.core.export.HttpMethod.POST)
        assertEquals(com.itangcent.easyapi.core.export.HttpMethod.POST, copy.method)
