    ...
    fun testEndpointHasGrpcMetadata() = runTest {
        ...
        for (endpoint in endpoints) {
            ...
            assertTrue("Metadata should be GrpcMetadata", 
                endpoint.metadata is com.itangcent.easyapi.core.export.GrpcMetadata)
            
            val grpcMetadata = endpoint.metadata as com.itangcent.easyapi.core.export.GrpcMetadata
