...
class SpringMvcClassExporterTest : EasyApiLightCodeInsightFixtureTestCase() {
    ...
    fun testExportWithGetMapping() = runTest {
        ...
        val endpoints = exporter.export(psiClass!!)
        val getEndpoints = endpoints.filter { it.httpMetadata?.method == com.itangcent.easyapi.core.export.HttpMethod.GET }
    ...
    fun testExportWithPostMapping() = runTest {
        ...
        val endpoints = exporter.export(psiClass!!)
        val postEndpoints = endpoints.filter { it.httpMetadata?.method == com.itangcent.easyapi.core.export.HttpMethod.POST }
    ...
    fun testRequestMappingWithRequestBodyDefaultsToPost() = runTest {
        ...
        assertEquals(com.itangcent.easyapi.core.export.HttpMethod.POST, updateWithBody!!.httpMetadata?.method)
    }
    ...
    fun testRequestMappingWithoutBodyDefaultsToGet() = runTest {
        ...
        assertEquals(com.itangcent.easyapi.core.export.HttpMethod.GET, simple!!.httpMetadata?.method)
    }
    ...
    fun testExplicitGetWithBodyRemainsGet() = runTest {
        ...
        assertEquals(com.itangcent.easyapi.core.export.HttpMethod.GET, explicitGet!!.httpMetadata?.method)
    }
    ...
    fun testRequestMappingWithModelAttributeDefaultsToPost() = runTest {
        ...
        assertEquals(com.itangcent.easyapi.core.export.HttpMethod.POST, updateWithModel!!.httpMetadata?.method)
    }
    ...
    fun testResponseBodyIsPopulated() = runTest {
        ...
        assertTrue("responseBody should be an Object model", responseObj is com.itangcent.easyapi.core.psi.model.ObjectModel.Object)
        val fields = (responseObj as com.itangcent.easyapi.core.psi.model.ObjectModel.Object).fields
    ...
    fun testRequestBodyIsPopulated() = runTest {
        ...
        assertTrue("body should be an Object model", bodyObj is com.itangcent.easyapi.core.psi.model.ObjectModel.Object)
        val fields = (bodyObj as com.itangcent.easyapi.core.psi.model.ObjectModel.Object).fields
    ...
    fun testFieldCommentsArePopulated() = runTest {
        ...
        val bodyObj = createEndpoint.httpMetadata?.body as? com.itangcent.easyapi.core.psi.model.ObjectModel.Object
    ...
    fun testResponseBodyGenericTypeResolution() = runTest {
        ...
        val responseObj = createEndpoint.httpMetadata?.responseBody as? com.itangcent.easyapi.core.psi.model.ObjectModel.Object
        ...
        assertTrue(
            ...
            dataModel is com.itangcent.easyapi.core.psi.model.ObjectModel.Object
        )

        val userInfoFields = (dataModel as com.itangcent.easyapi.core.psi.model.ObjectModel.Object).fields
    ...
    fun testReturnDocOnGenericField() = runTest {
        ...
        val responseObj = endpoint.httpMetadata?.responseBody as? com.itangcent.easyapi.core.psi.model.ObjectModel.Object
        assertNotNull(responseObj)
    ...
    fun testMultipartFileFieldExportedAsFileParam() = runTest {
        ...
        assertEquals(
            ...
            com.itangcent.easyapi.core.export.ParameterType.FILE,
            profileImgParam!!.type
        )
        assertEquals(
            "profileImg should have Form binding",
            com.itangcent.easyapi.core.export.ParameterBinding.Form,
