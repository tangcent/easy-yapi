...
class RequestMappingResolverTest : EasyApiLightCodeInsightFixtureTestCase() {
    ...
    override fun setUp() {
        super.setUp()
        loadTestFiles()
        val annotationHelper = com.itangcent.easyapi.core.psi.helper.UnifiedAnnotationHelper()
        val engine = com.itangcent.easyapi.core.rule.engine.RuleEngine.getInstance(project)
