...
/**
 * Integration test for the `javax-validation` extension.
 *
 * The extension defines rules for [RuleKeys.FIELD_REQUIRED] and [RuleKeys.PARAM_REQUIRED]:
 *   - `field.required=@javax.validation.constraints.NotBlank` (and NotNull, NotEmpty)
 *   - `param.required=@javax.validation.constraints.NotBlank` (and NotNull, NotEmpty)
 *
 * With the AnnotationExpressionParser fix, a boolean rule like
 * `field.required=@javax.validation.constraints.NotNull` resolves to `true` when the
...
class JavaxValidationConfigIntegrationTest : EasyApiLightCodeInsightFixtureTestCase() {
    ...
    fun testFieldRequiredRuleForNotNullField() = runTest {
        val psiClass = findClass("com.itangcent.validation.javax.JavaxValidatedUserDTO")
        assertNotNull("Should find JavaxValidatedUserDTO", psiClass)
