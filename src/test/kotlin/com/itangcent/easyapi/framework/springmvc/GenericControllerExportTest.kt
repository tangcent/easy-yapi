...
class GenericControllerExportTest : EasyApiLightCodeInsightFixtureTestCase() {
    ...
    fun testCase1_InheritedMethodsExported() = runTest {
        ...
        val getItem = endpoints.find { it.path == "/string/item" && it.httpMetadata?.method == com.itangcent.easyapi.core.export.HttpMethod.GET }
        assertNotNull("Should export GET /string/item", getItem)

        val postItem = endpoints.find { it.path == "/string/item" && it.httpMetadata?.method == com.itangcent.easyapi.core.export.HttpMethod.POST }
