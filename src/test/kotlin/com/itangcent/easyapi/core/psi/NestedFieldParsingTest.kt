...
class NestedFieldParsingTest : EasyApiLightCodeInsightFixtureTestCase() {
    ...
    // ---- Verify toSimpleValue() SPI handles circular ObjectModel references ----
    ...
    fun testValueConverterHandlesCircularObjectModel() {
        ...
        val fields = linkedMapOf<String, com.itangcent.easyapi.core.psi.model.FieldModel>()
