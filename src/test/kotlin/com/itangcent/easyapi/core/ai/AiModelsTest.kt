...
class AiModelsTest : EasyApiLightCodeInsightFixtureTestCase() {
    ...
    fun testNoProviderTypesReferenced() {
        ...
        // Verify by checking the package — all types are in com.itangcent.easyapi.core.ai.
        ...
        dtoClasses.forEach { cls ->
            assertEquals(
                "DTO ${cls.simpleName} should be in com.itangcent.easyapi.core.ai",
                "com.itangcent.easyapi.core.ai",
