...
import com.itangcent.easyapi.channel.yapi.YapiMetadataPopulator
import com.itangcent.easyapi.channel.yapi.mock
import com.itangcent.easyapi.channel.yapi.open
import com.itangcent.easyapi.channel.yapi.status
import com.itangcent.easyapi.channel.yapi.tags
...
class YapiConfigIntegrationTest : EasyApiLightCodeInsightFixtureTestCase() {
     ...
     */
    private suspend fun exportWithYapiMetadata(psiClass: com.intellij.psi.PsiClass): List<com.itangcent.easyapi.core.export.ApiEndpoint> {
        val ruleEngine = RuleEngine.getInstance(project)
