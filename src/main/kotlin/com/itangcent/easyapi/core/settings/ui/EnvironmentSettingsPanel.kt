...
import com.itangcent.easyapi.core.script.env.EnvironmentData
...
class EnvironmentSettingsPanel(private val project: Project) : SettingsPanel<EnvironmentSettings>, com.itangcent.easyapi.core.logging.IdeaLog {
    ...
    override fun resetFrom(settings: EnvironmentSettings?) {
