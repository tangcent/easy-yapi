...
data class GeneralSettings(
    ...
    /**
     * Enables the Search Everywhere integration, which lists API endpoints in
     * IntelliJ's Search Everywhere (double `Shift`) under their own APIs tab.
     * It reads the retained API index, which a one-shot Dashboard refresh fills
     * even while API scanning is off, so this setting is independent of
     * [apiScanEnabled].
     */
    @StorageScope(Scope.APPLICATION) var searchEverywhereEnabled: Boolean = true,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (searchEverywhereEnabled != other.searchEverywhereEnabled) return false
    ...
    override fun hashCode(): Int {
        ...
        result = 31 * result + searchEverywhereEnabled.hashCode()
