...
import com.itangcent.easyapi.core.psi.model.ObjectModelUtils
import com.itangcent.easyapi.core.psi.type.PrimitiveKind
...
class EndpointBuilder(private val project: Project) {
    ...
    fun mergePathParameters(
        ...
        for (param in methodParams) {
            if (param.binding == com.itangcent.easyapi.core.export.ParameterBinding.Path) {
    ...
    companion object : com.itangcent.easyapi.core.logging.IdeaLog {
        /**
