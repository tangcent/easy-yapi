...
import com.itangcent.easyapi.core.settings.ui.EasyApiSettingsConfigurable
...
class InlineEnvironmentPanel(private val project: Project) : JPanel(BorderLayout()) {
    ...
    private val syncService: EnvironmentSyncSupport = EnvironmentSyncSupport.getInstance(project)
    ...
    private fun showSyncMenu() {
        ...
        val hasToken = syncService.isAvailable()
    ...
    fun updateSyncButtonState() {
        syncButton.isEnabled = syncService.isAvailable()
