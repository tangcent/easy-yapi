package com.itangcent.easyapi.core.script.env
...
class EnvironmentService(private val project: Project) : com.itangcent.easyapi.core.logging.IdeaLog {
    ...
    private fun persistEnvironmentData(data: EnvironmentData) {
        ...
        envSettings.projectEnvironments = if (projectEnvs.isNotEmpty()) {
