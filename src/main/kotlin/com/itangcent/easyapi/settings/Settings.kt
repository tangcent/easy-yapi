 ...
 * State is persisted via the unified [com.itangcent.easyapi.settings.state.UnifiedAppSettingsState]
 * / [com.itangcent.easyapi.settings.state.UnifiedProjectSettingsState] components — no per-module
