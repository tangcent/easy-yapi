 ...
 * Storage scope for a settings property.
 *
 * - [PROJECT]    — persisted per-project (in `easyapi.xml`, via [com.itangcent.easyapi.settings.state.UnifiedProjectSettingsState])
 * - [APPLICATION] — persisted globally (in `easyapi_app.xml`, via [com.itangcent.easyapi.settings.state.UnifiedAppSettingsState])
 */
