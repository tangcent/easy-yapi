 ...
 *
 * Mirrors [com.itangcent.easyapi.exporter.channel.ChannelRegistry]: it is the
...
class FieldFormatChannelRegistry(private val project: Project) : IdeaLog {
    ...
    companion object {
         ...
         *
         * Identical to [com.itangcent.easyapi.exporter.channel.ChannelRegistry.resolveEnabled],
