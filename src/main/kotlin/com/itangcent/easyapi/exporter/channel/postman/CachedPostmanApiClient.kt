...
class CachedPostmanApiClient(
    ...
    suspend fun uploadCollection(collection: com.itangcent.easyapi.exporter.channel.postman.model.PostmanCollection): UploadResult {
        return postmanClient.uploadCollection(collection)
    }

    suspend fun updateCollection(collectionUid: String, collection: com.itangcent.easyapi.exporter.channel.postman.model.PostmanCollection): UploadResult {
