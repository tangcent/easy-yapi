...
object MarkdownTemplateResolver : IdeaLog {
     ...
     *   [RemoteTemplateFetcher.fetch] with an [HttpClient][com.itangcent.easyapi.core.http.HttpClient]
     *   from [HttpClientProvider][com.itangcent.easyapi.core.http.HttpClientProvider]; in tests it
