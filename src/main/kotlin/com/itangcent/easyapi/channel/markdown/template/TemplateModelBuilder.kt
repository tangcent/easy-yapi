...
import com.itangcent.easyapi.channel.curl.CurlBuildOptions
import com.itangcent.easyapi.channel.curl.CurlBuilder
import com.itangcent.easyapi.channel.curl.CurlFormatOptions
...
object TemplateModelBuilder : IdeaLog {
    ...
    private fun com.itangcent.easyapi.core.export.ApiParameter.toParam(): Param = Param(
        name = name,
    ...
    private fun com.itangcent.easyapi.core.export.ApiHeader.toHeader(): Header = Header(
        name = name,
        value = value ?: "",
        required = required,
        description = description ?: "",
