...
import com.itangcent.easyapi.channel.hoppscotch.CachedHoppscotchApiClient
import com.itangcent.easyapi.channel.hoppscotch.HoppCollectionInfo
import com.itangcent.easyapi.channel.hoppscotch.HoppscotchApiClient
import com.itangcent.easyapi.channel.hoppscotch.asCached
...
class HoppscotchOptionsPanel(private val project: Project) : ChannelOptionsPanel, IdeaLog {
    ...
    private fun swing(block: () -> Unit) {
        com.itangcent.easyapi.core.internal.threading.swingSync { block() }
    }
