...
import com.itangcent.easyapi.channel.spi.PlaceholderSyntaxConverter
import com.itangcent.easyapi.channel.spi.PlaceholderTargetSyntax
...
class HoppscotchFormatter(
    ...
    private suspend fun resolveScript(ruleKey: com.itangcent.easyapi.core.rule.RuleKey.StringKey, endpoint: ApiEndpoint): String {
    ...
    private suspend fun resolveCollectionScript(
        collectionKey: com.itangcent.easyapi.core.rule.RuleKey.EventKey,
        classKey: com.itangcent.easyapi.core.rule.RuleKey.StringKey,
        methodKey: com.itangcent.easyapi.core.rule.RuleKey.StringKey,
