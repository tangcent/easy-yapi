...
import com.itangcent.idea.plugin.api.export.feign.FeignRequestClassExporter
...
@Exclusion(FeignRequestClassExporter::class)
open class YapiFeignRequestClassExporter : FeignRequestClassExporter() {
