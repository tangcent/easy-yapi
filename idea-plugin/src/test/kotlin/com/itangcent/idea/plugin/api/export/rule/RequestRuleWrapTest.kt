...
internal class RequestRuleWrapTest : PluginContextLightCodeInsightFixtureTestCase() {
    ...
    fun testSetBodyClass() {
        ...
        assertEquals(
            "{\"id\":0,\"@comment\":{\"id\":\"user id\",\"type\":\"user type\",\"name\":\"user name\",\"age\":\"user age\",\"birthDay\":\"user birthDay\",\"regtime\":\"user regtime\"},\"type\":0,\"name\":\"\",\"age\":0,\"sex\":0,\"birthDay\":{\"year\":0,\"@comment\":{\"year\":\"Gets the year field.\\n\\u003cp\\u003e\\nThis method returns the primitive{@code int} value for the year.\\n\\u003cp\\u003e\\nThe year returned by this method is proleptic as per{@code get(YEAR)}.\\nTo obtain the year-of-era, use{@code get(YEAR_OF_ERA)}.\",\"monthValue\":\"Gets the month-of-year field from 1 to 12.\\n\\u003cp\\u003e\\nThis method returns the month as an{@code int} from 1 to 12.\\nApplication code is frequently clearer if the enum{@link Month}\\nis used by calling{@link #getMonth()}.\",\"dayOfMonth\":\"Gets the day-of-month field.\\n\\u003cp\\u003e\\nThis method returns the primitive{@code int} value for the day-of-month.\",\"dayOfYear\":\"Gets the day-of-year field.\\n\\u003cp\\u003e\\nThis method returns the primitive{@code int} value for the day-of-year.\",\"leapYear\":\"Checks if the year is a leap year, according to the ISO proleptic\\ncalendar system rules.\\n\\u003cp\\u003e\\nThis method applies the current rules for leap years across the whole time-line.\\nIn general, a year is a leap year if it is divisible by four without\\nremainder. However, years divisible by 100, are not leap years, with\\nthe exception of years divisible by 400 which are.\\n\\u003cp\\u003e\\nFor example, 1904 is a leap year it is divisible by 4.\\n1900 was not a leap year as it is divisible by 100, however 2000 was a\\nleap year as it is divisible by 400.\\n\\u003cp\\u003e\\nThe calculation is proleptic - applying the same rules into the far future and far past.\\nThis is historically inaccurate, but is correct for the ISO-8601 standard.\"},\"monthValue\":0,\"dayOfMonth\":0,\"dayOfYear\":0,\"leapYear\":false},\"regtime\":{\"year\":0,\"@comment\":{\"year\":\"Gets the year field.\\n\\u003cp\\u003e\\nThis method returns the primitive{@code int} value for the year.\\n\\u003cp\\u003e\\nThe year returned by this method is proleptic as per{@code get(YEAR)}.\\nTo obtain the year-of-era, use{@code get(YEAR_OF_ERA)}.\",\"monthValue\":\"Gets the month-of-year field from 1 to 12.\\n\\u003cp\\u003e\\nThis method returns the month as an{@code int} from 1 to 12.\\nApplication code is frequently clearer if the enum{@link Month}\\nis used by calling{@link #getMonth()}.\",\"dayOfMonth\":\"Gets the day-of-month field.\\n\\u003cp\\u003e\\nThis method returns the primitive{@code int} value for the day-of-month.\",\"dayOfYear\":\"Gets the day-of-year field.\\n\\u003cp\\u003e\\nThis method returns the primitive{@code int} value for the day-of-year.\",\"hour\":\"Gets the hour-of-day field.\",\"minute\":\"Gets the minute-of-hour field.\",\"second\":\"Gets the second-of-minute field.\",\"nano\":\"Gets the nano-of-second field.\"},\"monthValue\":0,\"dayOfMonth\":0,\"dayOfYear\":0,\"hour\":0,\"minute\":0,\"second\":0,\"nano\":0}}",
            request.body.toJson()
        )
    }
    ...
    fun testAddModelClass() {
        ...
        assertEquals(
            "[{\"name\":\"id\",\"value\":\"0\",\"desc\":\"user id\",\"required\":false,\"type\":\"text\"},{\"name\":\"@comment\",\"value\":\"{id: user id, type: user type, name: user name, age: user age, sex: null, birthDay: user birthDay, regtime: user regtime}\",\"desc\":\"\",\"required\":false,\"type\":\"text\"},{\"name\":\"type\",\"value\":\"0\",\"desc\":\"user type\",\"required\":false,\"type\":\"text\"},{\"name\":\"name\",\"value\":\"\",\"desc\":\"user name\",\"required\":false,\"type\":\"text\"},{\"name\":\"age\",\"value\":\"0\",\"desc\":\"user age\",\"required\":false,\"type\":\"text\"},{\"name\":\"sex\",\"value\":\"0\",\"desc\":\"\",\"required\":false,\"type\":\"text\"},{\"name\":\"birthDay\",\"value\":\"{year: 0, @comment: {year: Gets the year field.\\n\\u003cp\\u003e\\nThis method returns the primitive{@code int} value for the year.\\n\\u003cp\\u003e\\nThe year returned by this method is proleptic as per{@code get(YEAR)}.\\nTo obtain the year-of-era, use{@code get(YEAR_OF_ERA)}., monthValue: Gets the month-of-year field from 1 to 12.\\n\\u003cp\\u003e\\nThis method returns the month as an{@code int} from 1 to 12.\\nApplication code is frequently clearer if the enum{@link Month}\\nis used by calling{@link #getMonth()}., dayOfMonth: Gets the day-of-month field.\\n\\u003cp\\u003e\\nThis method returns the primitive{@code int} value for the day-of-month., dayOfYear: Gets the day-of-year field.\\n\\u003cp\\u003e\\nThis method returns the primitive{@code int} value for the day-of-year., leapYear: Checks if the year is a leap year, according to the ISO proleptic\\ncalendar system rules.\\n\\u003cp\\u003e\\nThis method applies the current rules for leap years across the whole time-line.\\nIn general, a year is a leap year if it is divisible by four without\\nremainder. However, years divisible by 100, are not leap years, with\\nthe exception of years divisible by 400 which are.\\n\\u003cp\\u003e\\nFor example, 1904 is a leap year it is divisible by 4.\\n1900 was not a leap year as it is divisible by 100, however 2000 was a\\nleap year as it is divisible by 400.\\n\\u003cp\\u003e\\nThe calculation is proleptic - applying the same rules into the far future and far past.\\nThis is historically inaccurate, but is correct for the ISO-8601 standard.}, monthValue: 0, dayOfMonth: 0, dayOfYear: 0, leapYear: false}\",\"desc\":\"user birthDay\",\"required\":false,\"type\":\"text\"},{\"name\":\"regtime\",\"value\":\"{year: 0, @comment: {year: Gets the year field.\\n\\u003cp\\u003e\\nThis method returns the primitive{@code int} value for the year.\\n\\u003cp\\u003e\\nThe year returned by this method is proleptic as per{@code get(YEAR)}.\\nTo obtain the year-of-era, use{@code get(YEAR_OF_ERA)}., monthValue: Gets the month-of-year field from 1 to 12.\\n\\u003cp\\u003e\\nThis method returns the month as an{@code int} from 1 to 12.\\nApplication code is frequently clearer if the enum{@link Month}\\nis used by calling{@link #getMonth()}., dayOfMonth: Gets the day-of-month field.\\n\\u003cp\\u003e\\nThis method returns the primitive{@code int} value for the day-of-month., dayOfYear: Gets the day-of-year field.\\n\\u003cp\\u003e\\nThis method returns the primitive{@code int} value for the day-of-year., hour: Gets the hour-of-day field., minute: Gets the minute-of-hour field., second: Gets the second-of-minute field., nano: Gets the nano-of-second field.}, monthValue: 0, dayOfMonth: 0, dayOfYear: 0, hour: 0, minute: 0, second: 0, nano: 0}\",\"desc\":\"user regtime\",\"required\":false,\"type\":\"text\"}]",
            request.formParams.toJson()
        )
    }
