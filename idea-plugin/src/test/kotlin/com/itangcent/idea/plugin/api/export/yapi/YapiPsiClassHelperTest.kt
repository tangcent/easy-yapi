...
internal class YapiPsiClassHelperTest : ContextualPsiClassHelperBaseTest() {
    ...
    override fun customConfig(): String {
        return "json.rule.field.name=@com.fasterxml.jackson.annotation.JsonProperty#value\n" +
                ...
                "json.additional.field[com.itangcent.model.UserInfo]={\"name\":\"label\",\"defaultValue\":\"genius\",\"type\":\"java.lang.String\",\"desc\":\"label of the user\",\"required\":true,\"mock\":\"@string\",\"example\":\"genius\",\"advanced\":\"some\"}\n" +
                "json.additional.field[com.itangcent.model.UserInfo#name]={\"name\":\"firstName\",\"defaultValue\":\"tang\",\"type\":\"java.lang.String\",\"desc\":\"a family name\",\"required\":false,\"mock\":\"@string\",\"example\":\"tang\",\"advanced\":\"some\"}\n" +
                "json.additional.field[com.itangcent.model.UserInfo#age]={\"name\":\"order\",\"defaultValue\":\"12\",\"type\":\"int\",\"desc\":\"order of the age in family\",\"required\":true,\"mock\":\"@int\",\"example\":\"12\",\"advanced\":\"some\"}"
    }
    ...
    fun testYapiPsiClassHelper() {
        ...
        assertEquals(
            "{\"id\":0,\"@required\":{\"id\":false,\"type\":false,\"name\":true,\"firstName\":false,\"age\":true,\"order\":true,\"sex\":false,\"birthDay\":false,\"regtime\":false,\"label\":true},\"@default\":{\"id\":\"0\",\"name\":\"tangcent\",\"firstName\":\"tang\",\"order\":\"12\",\"label\":\"genius\"},\"type\":0,\"name\":\"tangcent\",\"@mock\":{\"name\":\"tangcent\",\"firstName\":\"@string\",\"age\":\"1\",\"order\":\"@int\",\"label\":\"@string\"},\"firstName\":\"\",\"@example\":{\"firstName\":\"tang\",\"order\":\"12\",\"sex\":\"1\",\"label\":\"genius\"},\"@advanced\":{\"firstName\":\"some\",\"order\":\"some\",\"label\":\"some\"},\"age\":0,\"order\":0,\"sex\":1,\"birthDay\":\"\",\"regtime\":\"\",\"label\":\"\"}",
            GsonUtils.toJson(
                psiClassHelper.getTypeObject(
        ...
        assertEquals(
            "{\"id\":0,\"@required\":{\"id\":false,\"type\":false,\"name\":true,\"firstName\":false,\"age\":true,\"order\":true,\"sex\":false,\"birthDay\":false,\"regtime\":false,\"label\":true},\"@default\":{\"id\":\"0\",\"name\":\"tangcent\",\"firstName\":\"tang\",\"order\":\"12\",\"label\":\"genius\"},\"@comment\":{\"id\":\"user id\",\"type\":\"user type\",\"name\":\"user name\",\"firstName\":\"a family name\",\"age\":\"user age\",\"order\":\"order of the age in family\",\"birthDay\":\"user birthDay\",\"regtime\":\"user regtime\",\"label\":\"label of the user\"},\"type\":0,\"name\":\"tangcent\",\"@mock\":{\"name\":\"tangcent\",\"firstName\":\"@string\",\"age\":\"1\",\"order\":\"@int\",\"label\":\"@string\"},\"firstName\":\"\",\"@example\":{\"firstName\":\"tang\",\"order\":\"12\",\"sex\":\"1\",\"label\":\"genius\"},\"@advanced\":{\"firstName\":\"some\",\"order\":\"some\",\"label\":\"some\"},\"age\":0,\"order\":0,\"sex\":1,\"birthDay\":\"\",\"regtime\":\"\",\"label\":\"\"}",
            GsonUtils.toJson(
                psiClassHelper.getTypeObject(
                    PsiTypesUtil.getClassType(userInfoPsiClass), userInfoPsiClass,
                    JsonOption.ALL
