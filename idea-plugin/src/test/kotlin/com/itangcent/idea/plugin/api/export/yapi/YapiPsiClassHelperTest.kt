...
internal class YapiPsiClassHelperTest : ContextualPsiClassHelperBaseTest() {
    ...
    fun testYapiPsiClassHelper() {
        ...
        assertEquals(
            "{\"id\":0,\"@required\":{\"id\":false,\"type\":false,\"name\":true,\"firstName\":false,\"age\":true,\"order\":true,\"sex\":false,\"birthDay\":false,\"regtime\":false,\"label\":true},\"@default\":{\"id\":\"0\",\"name\":\"tangcent\",\"firstName\":\"tang\",\"order\":\"12\",\"label\":\"genius\"},\"@comment\":{\"id\":\"user id\",\"type\":\"user type\",\"name\":\"user name\",\"firstName\":\"a family name\",\"age\":\"user age\",\"order\":\"order of the age in family\",\"birthDay\":\"user birthDay\",\"regtime\":\"user regtime\",\"label\":\"label of the user\"},\"type\":0,\"name\":\"\",\"@mock\":{\"name\":\"tangcent\",\"firstName\":\"@string\",\"age\":\"1\",\"order\":\"@int\",\"label\":\"@string\"},\"firstName\":\"\",\"@demo\":{\"firstName\":\"tang\",\"order\":\"12\",\"sex\":\"1\",\"label\":\"genius\"},\"@advanced\":{\"firstName\":\"some\",\"order\":\"some\",\"label\":\"some\"},\"age\":0,\"order\":0,\"sex\":0,\"birthDay\":\"\",\"regtime\":\"\",\"label\":\"\"}",
            GsonUtils.toJson(
                psiClassHelper.getTypeObject(
                    PsiTypesUtil.getClassType(userInfoPsiClass), userInfoPsiClass,
                    JsonOption.ALL
