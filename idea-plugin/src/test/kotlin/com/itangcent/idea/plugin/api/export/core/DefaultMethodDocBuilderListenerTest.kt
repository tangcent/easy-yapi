...
internal class DefaultMethodDocBuilderListenerTest : AdvancedContextTest() {
    ...
    @Test
    fun testSetName() {
        methodDocBuilderListener.setName(FakeExportContext.INSTANCE,
                methodDoc, "test")
    ...
    @Test
    fun testAppendDesc() {
        methodDocBuilderListener.appendDesc(FakeExportContext.INSTANCE,
                methodDoc, "abc")
    ...
    @Test
    fun testAddParam() {
        methodDocBuilderListener.addParam(FakeExportContext.INSTANCE,
    ...
    @Test
    fun testSetRet() {
        methodDocBuilderListener.setRet(FakeExportContext.INSTANCE,
                methodDoc, "ret")
    ...
    fun testAppendRetDesc() {
        methodDocBuilderListener.appendRetDesc(FakeExportContext.INSTANCE,
                methodDoc, "abc")
