...
internal class JsRuleParserTest : RuleParserBaseTest() {
    ...
    fun testParseStringRule() {
        ...
        val ruleReadGetMapping: StringRule = ruleParser.parseStringRule("js:it.ann(\"org.springframework.web.bind.annotation.GetMapping\")")!!
    ...
    fun testParseBooleanRule() {
        val ruleCheckPublic: BooleanRule = ruleParser.parseBooleanRule("js:it.hasAnn(\"org.springframework.web.bind.annotation.RequestMapping\")")!!
        ...
        val ruleCheckNotPublic: BooleanRule = ruleParser.parseBooleanRule("js:!it.hasAnn(\"org.springframework.web.bind.annotation.RequestMapping\")")!!
    ...
    fun testParseEventRule() {
        ruleParser.parseEventRule("js:logger.info(\"hello world\")")!!.compute(ruleParser.contextOf(listPsiClass, listPsiClass))
