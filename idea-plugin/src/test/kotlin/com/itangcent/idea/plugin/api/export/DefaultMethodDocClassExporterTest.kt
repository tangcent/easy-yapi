...
/**
 * Test case of [DefaultMethodDocClassExporter]
 */
internal class DefaultMethodDocClassExporterTest
    ...
    override fun bind(builder: ActionContext.ActionContextBuilder) {
        super.bind(builder)
        builder.bind(ClassExporter::class) { it.with(DefaultMethodDocClassExporter::class).singleton() }
